    ...
    <PageContainer>
      ...
      <div className="xl:flex xl:space-y-0 space-y-8 xl:space-x-6 mt-6 ">
        <div className="xl:w-[70%] grid grid-cols-2  gap-4 md:gap-6">
          <SocialCard
            name="Behance"
            link="/"
            icon={<BehanceIcon className=" text-white group-hover:text-zinc-700 duration-500" />}
          />
          <SocialCard
            name="Dribbble"
            link="/"
            icon={<DribbbleIcon className="text-white group-hover:text-zinc-700 duration-500" />}
          />
          <SocialCard
            name="LinkedIn"
            link="/behance"
            icon={<LinkedInIcon className="text-white group-hover:text-zinc-700 duration-500" />}
          />
          <SocialCard
            name="Twitter"
            link="/behance"
            icon={<TwitterIcon className="text-white group-hover:text-zinc-700 duration-500" />}
          />
        </div>
      ...
      <Link href="#top">
        <div className="group flex--items space-x-3 text-center justify-center mt-4 pl-8 pb-6">
          <ArrowRight className="w-6 lg:w-8" />
