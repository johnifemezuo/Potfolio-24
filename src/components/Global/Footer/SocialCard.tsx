  ...
  return (
    <Link href={link} passHref target="_blank">
      <div className="hover:border-white transition-all duration-500 group relative border border-border-color rounded-xl p-3 md:p-6 h-[300px] lg:h-[400px]">
        <span className="group-hover:bg-white border rounded-full border-border-color group-hover:border-white transition-all duration-500 w-14 h-14 lg:w-16 lg:h-16 p-4 grid place-content-center">
          {icon}
        </span>
