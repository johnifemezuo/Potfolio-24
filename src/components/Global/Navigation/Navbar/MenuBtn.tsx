...
export const MenuBtn = ({ onClick }: { onClick?: () => void }) => {
  return (
    <button onClick={onClick} className="flex--items space-x-3 group">
      ...
      <div className="space-y-1.5 group-hover:bg-white transition duration-500 group-hover:bg-stone-700 rounded-full grid place-content-center w-12 h-12 md:w-16 md:h-16 md:space-y-2">
