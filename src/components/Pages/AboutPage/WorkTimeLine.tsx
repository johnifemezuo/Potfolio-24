  ...
  return (
    <div className="relative group">
      <div className=" duration-500  cursor-pointer  hover:text-black border-y py-4 md:py-5 border-white/20 text-light tracking-tighter flex items-center justify-between text-xl md:text-2xl text-white hover:bg-white transition-all ">
        ...
        <h3 className="text-left min-w-[120px] md:w-[300px] text-lg md:text-2xl">{company}</h3>{" "}
        <h3 className="text-base md:text-2xl text-zinc-500 min-w-[150px] md:w-[200px]">{role}</h3>{" "}
        <h3 className="text-zinc-500 text-base md:text-2xl w-[120px] md:w-[200px]">{year}</h3>
      ...
      <div className="z-40 w-[360px] invisible group-hover:visible transition-all  hidden md:block h-[300px] bg-white absolute -top-12 right-20">
        <Image
          src={image}
          alt="me"
          width={400}
